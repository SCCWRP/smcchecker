...
def hydromod(all_dfs):
   ...
   # END OF CHECK - If FullyArmored is No and LateralSusceptibilityL is 2 then following is required (cannot be -88) (🛑 ERROR 🛑)
    ...
    errs.append(
        ...
        'tbl_hydromod',
        hydromod[
            (hydromod.fullyarmored == "Yes") & 
            (~hydromod.streambedstate.isin(['NR','C']))
        ].tmp_row.tolist(), 
        'streambedstate',
        'Undefined Error',
    ...
    errs.append(
        ...
        hydromod[
            (hydromod.fullyarmored == "Yes") & 
            (~hydromod.gradecontrol.isin(['A','NR']))
        ].tmp_row.tolist(), 
        'gradecontrol',
        'Undefined Error',
    ...
    errs.append(
        ...
        hydromod[
            (hydromod.fullyarmored == "Yes") & 
            (~hydromod.armoringpotential.isin(['A','NR']))
        ].tmp_row.tolist(), 
        'armoringpotential',
        'Undefined Error',
    ...
    errs.append(
        checkData(
            ...
            hydromod[
                (hydromod.fullyarmored == "Yes") & 
                (hydromod.lateralsusceptibilityl != 1)
            ].tmp_row.tolist(), 
    ...
    errs.append(
        ...
        hydromod[
            (hydromod.fullyarmored == "Yes") & 
            (hydromod.lateralsusceptibilityr != 1)
        ].tmp_row.tolist(), 
